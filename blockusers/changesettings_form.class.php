...
class changesettings_form extends moodleform {
	...
	public function addElements($users)
	{
		...
		$table->head = array(get_string('sno','local_blockusers'),get_string('usersblocked', 'local_blockusers'));
		$table->data =  $users;
		...
		$mform->addElement('submit', 'submitbutton', get_string('blockusers', 'local_blockusers'));
	}
}
?>
